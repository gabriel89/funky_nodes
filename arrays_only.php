<?php
	...
	* @author Gabriel Barina <barinagabriel2007@yahoo.com>
	*/
	function compareAndMerge ($v1, $v2) {
		printVector ('v1', $v1);
		printVector ('v2', $v2);
	...
	*/
	...
	$v1 = $random ? generateVector() : array('a/1', 'a/2', 'a/3', 'a/4', 'a/128', 'a/129', 'b/65', 'b/66', 'c/1', 'c/10', 'c/42');
	$v2 = $random ? generateVector() : array('a/1', 'a/2', 'a/3', 'a/4', 'a/5', 'a/126', 'a/127', 'b/100', 'c/2', 'c/3', 'd/1');

	compareAndMerge ($v1, $v2);
